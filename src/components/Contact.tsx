      ...
      <div className="max-w-4xl mx-auto px-8 w-full">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
          ...
          <a
            ...
            className="flex items-center gap-3 px-6 py-4 bg-gray-900 border border-gray-800 rounded-lg hover:border-purple-500 hover:bg-gray-800 transition-all duration-200 group w-full sm:w-auto justify-center"
          >
            <svg
